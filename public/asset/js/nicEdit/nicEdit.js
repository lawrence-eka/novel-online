...
var nicEditors = {
	...
	allTextAreas : function(nicOptions) {
		for(;nicEditors.editors.length;nicEditors.editors.pop());
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		this.ne.options.maxHeight = parseInt(this.ne.options.maxHeight) ? parseInt(this.ne.options.maxHeight) - 44 : null;
		this.ne.options.minHeight = parseInt(this.ne.options.minHeight) ? parseInt(this.ne.options.minHeight) - 44 : null;


		newX = parseInt(e.getStyle('width')) || e.clientWidth;
		newY = parseInt(this.ne.options.minHeight) || parseInt(e.getStyle('height')) || e.clientHeight;
		this.initialHeight = newY-8;
		
		var isTextarea = (e.nodeName.toLowerCase() == "textarea");
		if(isTextarea || this.options.hasPanel) {
			var ie7s = (bkLib.isMSIE && !((typeof document.body.style.maxHeight != "undefined") && document.compatMode == "CSS1Compat"))
			var s = {width: newX+'px', border : '1px solid #ccc', borderTop : 0, overflowY : 'scroll', overflowX: 'hidden' };
			s[(ie7s) ? 'height' : 'maxHeight'] = (this.ne.options.maxHeight) ? this.ne.options.maxHeight+'px' : null;
			this.editorContain = new bkElement('DIV').setStyle(s).appendBefore(e);
			newX = this.editorContain.clientWidth;
			var editorElm = new bkElement('DIV').setStyle({width : (newX-8)+'px', margin: '4px', minHeight : newY+'px', outline:'none'}).addClass('main').appendTo(this.editorContain);
